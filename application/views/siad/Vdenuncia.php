					...
					<nav style="background: transparent; box-shadow: none;">
						<div class="nav-wrapper">
							<div class="col s12">
								...
								<a href="<?php echo base_url();?>Siad/Denuncias" class="breadcrumb hide-on-small-only" style="font-weight: bold; color: #1e1e1e;" onclick="$('#spinner').css({'opacity':'1','visibility':'visible'}); $('body').css('overflow','hidden');">Denuncias</a>
